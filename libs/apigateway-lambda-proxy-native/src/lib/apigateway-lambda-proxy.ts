...
import { LambdaFunction } from '@wanews/pulumi-lambda-native'
import * as apigatewayv2 from '@pulumi/aws-native/apigatewayv2'
...
export class ApiGatewayLambdaProxy extends pulumi.ComponentResource {
    ...
    apiGatewayDomainName: apigatewayv2.DomainName | undefined
    apiGatewayHostname: pulumi.Output<string>
    lambdaExecutionRole: pulumi.Output<iam.Role>
    ...
    constructor(
        name: string,
        {
             ...
             */
            lambdaOptions: Omit<lambda.FunctionArgs, 'role'>
        ...
        this.apiGatewayHostname = pulumi.interpolate`${this.apiGateway.id}.execute-api.${region.name}.amazoncom`
