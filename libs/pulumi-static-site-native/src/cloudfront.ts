import { cloudfront } from '@pulumi/aws-native/types/input'
...
export interface CfDistributionOptions {
    ...
    lambdaFunctionAssociations?: pulumi.Input<
        pulumi.Input<cloudfront.DistributionLambdaFunctionAssociationArgs>[]
    >
    additionalOrigins?: pulumi.Input<
        pulumi.Input<cloudfront.DistributionOriginArgs>[]
    >
    orderedCacheBehaviors?: pulumi.Input<
        pulumi.Input<cloudfront.DistributionCacheBehaviorArgs>[]
    >
}
...
export class StaticDistribution extends pulumi.ComponentResource {
